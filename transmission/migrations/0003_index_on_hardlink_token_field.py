...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Hardlink', fields ['token']
        db.create_index(u'transmission_hardlink', ['token'])


    def backwards(self, orm):
        # Removing index on 'Hardlink', fields ['token']
        db.delete_index(u'transmission_hardlink', ['token'])
