...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'View'
        db.create_table(u'transmission_view', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['transmission.File'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='viewed', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'transmission', ['View'])


    def backwards(self, orm):
        # Deleting model 'View'
        db.delete_table(u'transmission_view')
